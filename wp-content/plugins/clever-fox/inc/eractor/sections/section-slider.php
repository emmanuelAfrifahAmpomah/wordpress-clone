...
?>
	<!--===// Start: Slider
	=====================-->
	<section id="main-slider" class="main-slider-3 slider-style-3">
		<div class="row">
			<div class="col-md-12">
				<div class="home-slider owl-carousel">
					<?php
						...
						?>
							<div class="item">
								<?php if ( ! empty( $image ) ) : ?>
									<img src="<?php echo esc_url($image); ?>" data-img-url="<?php echo esc_url($image); ?>" alt="<?php echo esc_attr__('Image','eractor'); ?>" data-animation-in="zoomInImage">
								<?php endif; ?>	
