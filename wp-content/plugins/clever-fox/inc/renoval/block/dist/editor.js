 ...
 function oa(a) {
    ...
    (0, a.registerBlockType)("info-box/infos", {
        ...
        edit: function (a) {
            ...
            return wp.element.createElement(
                ...
                wp.element.createElement(
                    "div",
                    { className: o, id: "renovalInfos-".concat(O) },
                    wp.element.createElement("style", {
                        dangerouslySetInnerHTML: {
                            __html: "\n                    @import url("
                                .concat(O, " .renovalInfos .renovalInfo .title{\n                        ")
                                .concat(O, " .renovalInfos .renovalInfo .description{\n                        "),
                        },
                    }),
                    wp.element.createElement(
                        "div",
    ...
    var Da = function (a) {
            ...
            return (
                ...
                wp.element.createElement(
                    ...
                    wp.element.createElement(
                        t.PanelRow,
                        { className: "renovalIconTitle ".concat(n) },
        ...
        Ra = function (a) {
            ...
            return (
                ...
                wp.element.createElement(
                    ...
                    wp.element.createElement(
                        "div",
                        { className: i, id: "renovalInfo-".concat(x) },
                        wp.element.createElement("style", {
                            dangerouslySetInnerHTML: {
                                __html: "\n                #renovalInfo-"
                                    .concat(x, " .renovalInfo .bgLayer{\n                    ")
                                    .concat(x, " .renovalInfo .title{\n                    color: ")
                                    .concat(x, " .renovalInfo .icon{\n                    ")
                                    .concat((null == m ? void 0 : m.styles) || "font-size: 70px;", "\n                }\n                #renovalInfo-")
                                    .concat(x, " .renovalInfo .description{\n                    color: ")
                                    .concat(x, " .renovalInfo .link a svg{\n                    fill: "),
                            },
                        }),
                        wp.element.createElement(
                            "div",
							{ className: "renovalInfo av-column-".concat(m.desktop, " columns-tablet-").concat(m.tablet, " av-sm-column-").concat(m.mobile)},
    ...
    (0, a.registerBlockType)("info-box/info", {
        ...
        attributes: {
            ...
            title: { type: "string", selector: ".renovalInfo span.title", default: "Info title" },
            isDesc: { type: "boolean", default: !0 },
            desc: { type: "string", selector: ".renovalInfo h3.description", default: "Lorem ipsum dolor sit, amet consectetur adipisicing elit. Accusamus, fuga." },
