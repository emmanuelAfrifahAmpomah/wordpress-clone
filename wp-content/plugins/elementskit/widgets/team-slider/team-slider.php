    ...
    protected function register_controls() {
        ...
        $this->add_responsive_control(
			...
			[
				...
				'selectors' => [
					'{{WRAPPER}} .ekit-team-slider .elementor-swiper-button > i' => 'font-size: {{SIZE}}{{UNIT}};',
		...
		$this->add_control(
			...
			[
				...
				'selectors' => [
					'{{WRAPPER}} .ekit-team-slider .slick-dots .swiper-pagination-bullet' => 'margin-right: {{SIZE}}{{UNIT}};margin-left: {{SIZE}}{{UNIT}};',
				],
			]
		);
		...
		$this->add_control(
			...
			[
				...
				'selectors' => [
					'{{WRAPPER}} .ekit-team-slider .slick-dots .swiper-pagination-bullet' => 'width: {{SIZE}}{{UNIT}};',
				],
			]
		);
		...
		$this->add_control(
			...
			[
				...
				'selectors' => [
					'{{WRAPPER}} .ekit-team-slider .slick-dots .swiper-pagination-bullet' => 'height: {{SIZE}}{{UNIT}};',
				],
			]
		);
        ...
        $this->add_group_control(
			...
			[
				...
				'label' => esc_html__( 'Border', 'elementskit' ),
				'selector' => '{{WRAPPER}} .ekit-team-slider .slick-dots .swiper-pagination-bullet',
			]
        );
		...
		$this->add_control(
			...
			[
				...
				'size_units' => [ 'px', '%' ],
				'selectors' => [
					'{{WRAPPER}} .ekit-team-slider .slick-dots .swiper-pagination-bullet' => 'border-radius: {{TOP}}{{UNIT}} {{RIGHT}}{{UNIT}} {{BOTTOM}}{{UNIT}} {{LEFT}}{{UNIT}};',
				],
			]
		);
		...
		$this->add_group_control(
			...
			[
				...
				'types' => [ 'classic', 'gradient' ],
				'exclude' => ['image'],
				'selector' => '{{WRAPPER}} .ekit-team-slider .slick-dots .swiper-pagination-bullet-active',
			]
		);
		...
		$this->add_responsive_control(
			...
			[
				...
				'selectors' => [
					'{{WRAPPER}} .ekit-team-slider .slick-dots .swiper-pagination-bullet-active' => 'transform: scale({{SIZE}});',
				],
			]
		);
        ...
        $this->add_control(
			...
			[
				...
				'selectors' => [
					'{{WRAPPER}} .ekit-team-slider .slick-dots .swiper-pagination-bullet-active' => 'transform: translateY({{SIZE}}{{UNIT}});',
				],
			]
		);
        ...
        $this->add_control(
			...
			[
				...
				'size_units' => [ 'px' ],
				'selectors' => [
					'{{WRAPPER}} .ekit-team-slider .slick-dots .swiper-pagination-bullet-active' => 'width: {{SIZE}}{{UNIT}};',
				],
			]
		);
		...
		$this->add_control(
			...
			[
				...
				'size_units' => [ 'px' ],
				'selectors' => [
					'{{WRAPPER}} .ekit-team-slider .slick-dots .swiper-pagination-bullet-active' => 'height: {{SIZE}}{{UNIT}};',
				],
			]
		);
